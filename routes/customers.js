...
router.get(
  "/",
  /* authentication_mdl.is_login, */ function (req, res, next) {
...
router.post(
  ...
  /* authentication_mdl.is_login, */ function (req, res, next) {
    ...
    if (!errors) {
      ...
      req.getConnection(function (err, connection) {
        var query = connection.query(insert_sql, customer, function (
          err,
          result
        ) {
          if (err) {
...
router.put(
  ...
  /* authentication_mdl.is_login, */ function (req, res, next) {
    ...
    if (!errors) {
      ...
      req.getConnection(function (err, connection) {
        var query = connection.query(update_sql, customer, function (
          err,
          result
        ) {
          if (err) {
...
router.delete(
  ...
  /* authentication_mdl.is_login, */ function (req, res, next) {
    req.getConnection(function (err, connection) {
      ...
      req.getConnection(function (err, connection) {
        var query = connection.query(delete_sql, customer, function (
          err,
          result
        ) {
          if (err) {
